...
public class MyCanvasViewEdit extends View {
    ...
    MyCanvasViewEdit(Context context) {
        this(context, null);
    }

    public MyCanvasViewEdit(Context context, AttributeSet attributeSet) {
        super(context);

        mBackgroundColor = ResourcesCompat.getColor(getResources(),
                R.color.opaque_orange1, null);
        mDrawColor = ResourcesCompat.getColor(getResources(),
                R.color.opaque_yellow1, null);
