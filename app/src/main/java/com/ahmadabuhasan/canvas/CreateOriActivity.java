...
public class CreateOriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("ORI Create Canvas objects");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.edit_create) {
            startActivity(new Intent(this, CreateEditActivity.class));
            Toast.makeText(CreateOriActivity.this, "Edit Create Canvas objects", 1000).show();
        }
        return true;
    }
}
